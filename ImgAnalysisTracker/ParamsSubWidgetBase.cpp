...
void ParamsSubWidgetBase::connectSlider(BioTracker::Widgets::SpinBoxWithSlider *slider, const std::string &paramName,
...
void ParamsSubWidgetBase::connectSettingsWidget(QCheckBox *check, const std::string &paramName,
        const BeesBookCommon::Stage &stage) {
...
void ParamsSubWidgetBase::connectSettingsWidget(QSpinBox *spin, const std::string &paramName,
        const BeesBookCommon::Stage &stage) {
    int initialValue = _settings.getValueOfParam<int>(paramName);
...
void ParamsSubWidgetBase::connectSettingsWidget(QDoubleSpinBox *spin, const std::string &paramName,
        const BeesBookCommon::Stage &stage) {
...
void ParamsSubWidgetBase::connectSettingsWidget(QLineEdit *lineEdit, const std::string &paramName,
        const BeesBookCommon::Stage &stage) {
